...
return [
    ...
    'custom' => [
        'delivery_address' => [
            'min' => 'Пожалуйста, укажите полный адрес доставки.',
            'required' => 'Пожалуйста, укажите полный адрес доставки.',
        ],

        'password' => [
            'confirmed' => 'Пароль не совпадает с подтверждаемым.',
            'min' => [
                'string'  => 'Пароль не должен быть короче :min символов.',
            ],
        ],

        'new_password' => [
            'confirmed' => 'Новый пароль не совпадает с подтверждаемым.',
            'min' => [
                'string'  => 'Новый пароль не должен быть короче :min символов.',
            ],
        ],

        'user_image' => [
            'max' => 'Размер файла не может быть больше :max Кб.',
